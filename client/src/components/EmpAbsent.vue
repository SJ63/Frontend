        ...
        <div class="row mt-4 g-0">
            <div class="col">
                <table class="table table-striped table-hover table-responsive table-dark">
                    <caption class="text-white">Showing {{ 1 + ((pages-1)*10) }} to {{ max_scope_page }} of {{ filtered_not_work.length }}
                    ...
                    <tbody>
                        <tr
                            v-for="(item, index) in list_absent_filter_slice"
                            :key="item.autoID"
                        >
                            <td>{{ index+1 }}</td>
                            <td>{{ item.empId }}</td>
                            ...
                            <td><span
                                    id='clickableAwesomeFont'
                                    @click="selected_people(item.empId)"
